...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Nov 2020 pada 11.01
...
ALTER TABLE `kelurahan`
  ...
  ADD CONSTRAINT `fk_id_kecamatan_lurah` FOREIGN KEY (`id_kecamatan`) REFERENCES `kecamatan` (`id_kecamatan`) ON DELETE CASCADE ON UPDATE CASCADE,
